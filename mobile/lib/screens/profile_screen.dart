...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  void _performLogout() {
    try {
      // Clear all user data
      _settingsBox.delete('patient_id');
      _settingsBox.delete('patient_name');
      _settingsBox.delete('condition');
      _settingsBox.delete('session_token');
      _settingsBox.put('is_logged_in', false);

      // Clear check-ins from local storage
