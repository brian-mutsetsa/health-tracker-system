...
urlpatterns = [
    ...
    path('patient/<str:patient_id>/emergency-alert/', views.trigger_emergency_alert, name='trigger-emergency-alert'),
    path('patient/<str:patient_id>/send-reminder/', views.send_patient_reminder, name='send-patient-reminder'),
